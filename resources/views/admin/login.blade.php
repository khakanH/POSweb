...
<head>
    ...
    <style type="text/css">
        body { 
    background: url('{{asset('images/parallax/07.jpg')}}') no-repeat center center fixed;
    ...
    <div class="page-wrapper">
            <div class="container">
                <div class="login-wrap">
                    <div class="login-content" style="background: radial-gradient(black, transparent); color: white;">
                        ...
                        <div class="login-form">
                            <form action="{{route('sign-in')}}" method="post" name="loginForm">
                                @csrf
                                <span class='arrow'>
